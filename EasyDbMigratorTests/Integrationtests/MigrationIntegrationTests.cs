        ...
        public async Task the_scenario_when_nothing_goes_wrong_with_running_migrations_on_an_empty_database()
        {
            try
            {
                ...
                _ = loggerMock
                    ...
                    .CheckIfLoggerWasCalled("script: CreateDB was run", LogLevel.Information, Times.Exactly(1))
                    .CheckIfLoggerWasCalled("script: Script2 was run", LogLevel.Information, Times.Exactly(1))
                    .CheckIfLoggerWasCalled("script: Script1 was run", LogLevel.Information, Times.Exactly(1))
                    .CheckIfLoggerWasCalled("Whole migration process executed successfully", LogLevel.Information, Times.Exactly(1))
                    .CheckIfLoggerWasCalled("script: CreateDB was not run because migrations was already executed", LogLevel.Information, Times.Never())
                    .CheckIfLoggerWasCalled("script: Script2 was not run because migrations was already executed", LogLevel.Information, Times.Never())
                    .CheckIfLoggerWasCalled("script: Script1 was not run because migrations was already executed", LogLevel.Information, Times.Never());
            }
...
#pragma warning restore CA1031
        ...
        public async Task the_scenario_when_all_the_migration_script_allready_have_been_executed_before()
        {
            try
            {
                ...
                List<VersioningTableRow> expectedRows = new List<VersioningTableRow>();
                expectedRows.Add(new VersioningTableRow(id: 1, executed: ExecutedFirsttimeDataTime, scriptname: "CreateDB", version: "1.0.0"));
                expectedRows.Add(new VersioningTableRow(id: 2, executed: ExecutedFirsttimeDataTime, scriptname: "Script2", version: "1.0.0"));
                expectedRows.Add(new VersioningTableRow(id: 3, executed: ExecutedFirsttimeDataTime, scriptname: "Script1", version: "1.0.0"));
                ...
                _ = loggerMockSecondtRun
                    .CheckIfLoggerWasCalled("setup database when there is none with default settings executed successfully", LogLevel.Information, Times.Exactly(1))
                    .CheckIfLoggerWasCalled("setup DbMigrationsRun when there is none executed successfully", LogLevel.Information, Times.Exactly(1))
                    .CheckIfLoggerWasCalled("script: CreateDB was not run because migrations was already executed", LogLevel.Information, Times.Exactly(1))
                    .CheckIfLoggerWasCalled("script: Script2 was not run because migrations was already executed", LogLevel.Information, Times.Exactly(1))
                    .CheckIfLoggerWasCalled("script: Script1 was not run because migrations was already executed", LogLevel.Information, Times.Exactly(1))
                    .CheckIfLoggerWasCalled("Whole migration process executed successfully", LogLevel.Information, Times.Exactly(1))
                    .CheckIfLoggerWasCalled("script: CreateDB was run", LogLevel.Information, Times.Never())
                    .CheckIfLoggerWasCalled("script: Script2 was run", LogLevel.Information, Times.Never())
                    .CheckIfLoggerWasCalled("script: Script1 was run", LogLevel.Information, Times.Never());
            }
#pragma warning disable CA1031 // Do not catch general exception types, for sake of testing this is no problem
            catch (Exception ex)
#pragma warning restore CA1031
